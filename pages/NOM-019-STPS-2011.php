...
<?php 
    $query = "SELECT * FROM norma192011 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    ...
    if ($numRespuestas > 0) {
        $query2 = "SELECT " . implode(", ", $respuestasArray) . " FROM norma192011 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
...
<head>
    ...
    <title>Normas/NOM-019-STPS-2011.HTML</title>
</head>
<body>
    <div class="barrasuperior">
        <h1>NOM-019-STPS-2011</h1>
    ...
    <form action="guardar_n0192011.php" method="POST">
        <div>
            <h2>
                Disposición
            </h2>
            <label class="conteiner">5.1 Constituir e integrar al menos una comisión en el centro de trabajo.</label>
        </div>
        ...
        <div>
          ...
          <div class="conteiner">
              <label for="pregunta1">Presenta evidencia documental de que tiene constituida e integrada al menos una comisión.</label>
        ...
        <div>
            ...
            <label class="conteiner">5.4 Contar con el acta de constitución de la comisión del centro de trabajo, y de sus actualizaciones, cuando se modifique su integración.</label>
        </div>
        <hr class="styled-separator">
        <div>
            <h2>
        ...
        <div class="conteiner">
          <label for="pregunta2">Al entrevistar al menos a dos integrantes de la comisión, se constata que éstos forman parte de la misma.</label>
          <div class="radio-buttons">
        ...
        <div>
            ...
            <label class="conteiner">7 Constitución e integración de las comisiones.</label>
        </div>
        <hr class="styled-separator">
        <div>
            <h2>
        ...
        <div class="conteiner">
          <label for="pregunta3">Un trabajador y el patrón o su representante, cuando el centro de trabajo cuente con menos de 15 trabajadores.
          </label>
          <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta4">Un coordinador, un secretario y los vocales que acuerden el patrón o sus representantes, y el sindicato o el representante de los trabajadores, 
      ...
      <div class="conteiner">
        <label for="pregunta5">Presenta evidencia documental de que formalizó la constitución de la comisión, a través de un acta, en sesión con los miembros que se hayan 
      ...
      <div class="conteiner">
        <label for="pregunta6">Presenta evidencia documental de que el acta de constitución de cada comisión.
      ...
      <div class="conteiner">
        <label for="pregunta7">Datos del centro de trabajo:
        </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta8">El nombre, denominación o razón social.
          </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta9">El domicilio completo (calle, número, colonia, municipio o delegación, ciudad, entidad federativa, código postal).
      ...
      <div class="conteiner">
        <label for="pregunta10">El Registro Federal de Contribuyentes.
      ...
      <div class="conteiner">
        <label for="pregunta11">El Registro Patronal otorgado por el Instituto Mexicano del Seguro Social.
      ...
      <div class="conteiner">
        <label for="pregunta12">La rama industrial o actividad económica.
      ...
      <div class="conteiner">
        <label for="pregunta13">La fecha de inicio de actividades.
      ...
      <div class="conteiner">
        <label for="pregunta14">El número de trabajadores del centro de trabajo.
      ...
      <div class="conteiner">
        <label for="pregunta15">El número de turnos.
      ...
      <div class="conteiner">
        <label for="pregunta16">Datos de la comisión:
          </label>
        <div class="radio-buttons">
        ...
        <!-- Pregunta 17 -->
        <div class="conteiner">
          <label for="pregunta17">La fecha de integración de la comisión (día, mes y año).
            </label>
          <div class="radio-buttons">
        ...
        <!-- Pregunta 18 -->
        <div class="conteiner">
          <label for="pregunta18">El nombre y firma del patrón o de su representante, y del representante de los trabajadores, tratándose de centros de trabajo con menos de 15 trabajadores.
        ...
        <!-- Pregunta 19 -->
        <div class="conteiner">
          <label for="pregunta19">El nombre y firma del coordinador, secretario y vocales, en el caso de centros de trabajo con 15 trabajadores o más.
        ...
        <!-- Pregunta 20 -->
        <div class="conteiner">
          <label for="pregunta20">Presenta evidencia documental de que el acta de constitución de cada comisión se actualiza, cuando se modifica su integración.
        ...
        <!-- Pregunta 21 -->
        <div class="conteiner">
          <label for="pregunta21">Presenta evidencia documental de que en la constitución de dos o más comisiones de seguridad e higiene se tomó en consideración lo siguiente:
        ...
        <div class="conteiner">
          <label for="pregunta22">El número de turnos del centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta23">El número de trabajadores que integran cada turno de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta24">Los agentes y condiciones peligrosas de las áreas que integran al centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta25">Las empresas contratistas que desarrollen labores relacionadas con la actividad principal del centro de trabajo dentro de las instalaciones de este último.
        ...
        <div>
            ...
            <label class="conteiner">5.3 Solicitar al sindicato o a los trabajadores, si no hubiera sindicato, la designación de sus representantes para participar en la comisión. Dicha designación deberá realizarse con base en las funciones por desempeñar.
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta26">Presenta evidencia documental de que solicitó al sindicato o a los trabajadores, si no hubiera sindicato, la designación de sus representantes para participar en la comisión, con base en 
        ...
        <div>
            ...
            <label class="conteiner">5.5 Contar con el programa anual de los recorridos de verificación de la comisión.
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta27">Presenta evidencia documental de que cuenta con el programa anual de los recorridos de verificación de la comisión.
        ...
        <div>
            ...
            <label class="conteiner">9.3 El programa anual de recorridos de verificación deberá integrase dentro de los treinta días naturales siguientes a la constitución de la comisión. Posteriormente, se deberá conformar el programa dentro de los primeros treinta días naturales de cada año.
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta28">El programa anual de recorridos de verificación se integra dentro de los treinta días naturales siguientes a la constitución de la comisión. 
            Posteriormente, se conforma el programa dentro de los primeros treinta días naturales de cada año.
        ...
        <div>
            ...
            <label class="conteiner">9.4 En el programa anual se determinarán las prioridades de los recorridos de verificación, con base en las áreas con mayor presencia de agentes y condiciones peligrosas o inseguras, y a partir de los incidentes, accidentes y enfermedades de trabajo.
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta29">En el programa anual se determinan las prioridades de los recorridos de verificación, con base en las áreas con mayor presencia de agentes y condiciones peligrosas 
            o inseguras, y a partir de los incidentes, accidentes y enfermedades de trabajo.
        ...
        <div>
            ...
            <label class="conteiner">9.5 Los recorridos de verificación previstos en el programa anual de la comisión, se deberán realizar al menos con una periodicidad trimestral.
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta30">Los recorridos de verificación previstos en el programa anual de la comisión, se realizan al menos con una periodicidad trimestral.
        ...
        <div class="conteiner">
          <label for="pregunta31">Se identifiquen los agentes, condiciones peligrosas o inseguras y actos inseguros en el centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta32">Se investiguen las causas de los accidentes y enfermedades de trabajo que en su caso ocurran, de acuerdo con los elementos que les proporcione el patrón y otros que estimen necesarios.
        ...
        <div class="conteiner">
          <label for="pregunta33">Se determinen las medidas para prevenir riesgos de trabajo, con base en lo dispuesto por el Reglamento y las normas que resulten aplicables.
        ...
        <div class="conteiner">
          <label for="pregunta34">Se dé seguimiento a la instauración de las medidas propuestas por la comisión para prevenir los riesgos de trabajo.
        ...
        <div>
            ...
            <label class="conteiner">9.9 La comisión deberá efectuar verificaciones extraordinarias en caso de que:
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta35">Presenta evidencia documental de que efectúa verificaciones extraordinarias.
        ...
        <div class="conteiner">
          <label for="pregunta36">Ocurran accidentes o enfermedades de trabajo que generen defunciones o incapacidades permanentes.
        ...
        <div class="conteiner">
          <label for="pregunta37">Existan modificaciones significativas en las instalaciones y/o cambios en los procesos de trabajo, con base en la información proporcionada por el patrón 
            o a solicitud de los trabajadores.
        ...
        <div class="conteiner">
          <label for="pregunta38">Reporten los trabajadores la presencia de agentes y condiciones peligrosas o inseguras que, a juicio de la propia comisión, así lo ameriten.
        ...
        <div>
            ...
            <label class="conteiner">5.6 Contar con las actas de los recorridos de verificación realizados por la comisión.
            </label>
        </div>
        <hr class="styled-separator">
        <div>
        ...
        <div class="conteiner">
          <label for="pregunta39">Presenta evidencia documental de que cuenta con las actas de recorridos de verificación realizados por la comisión.
        ...
        <div>
            ...
            <label class="conteiner">9.12 Las actas de los recorridos de verificación.
            </label>
          </div>
             <hr class="styled-separator">
             <div>
        ...
        <div class="conteiner">
          <label for="pregunta40">El nombre, denominación o razón social del centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta41">El domicilio completo (calle, número, colonia, municipio o delegación, ciudad, entidad federativa, código postal).
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta42">El número de trabajadores del centro de trabajo.
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta43">El tipo de recorrido de verificación: ordinario (conforme al programa anual) o extraordinario
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta44">Las fechas y horas de inicio y término del recorrido de verificación.
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta45">El área o áreas del centro de trabajo en las que se realizó el recorrido de verificación.
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta46">Los agentes, condiciones peligrosas o inseguras y actos inseguros identificados durante el recorrido de verificación.
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta47">Las causas que, en su caso, se hayan identificado sobre los accidentes y enfermedades de trabajo que ocurran.
        ...
        <div class="conteiner">
          <label for="pregunta48">Las medidas para prevenir los riesgos de trabajo detectados, con base en lo dispuesto por el Reglamento y las normas que resulten aplicables.
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta49">Las recomendaciones que por consenso se determinen en el seno de la comisión para prevenir, reducir o eliminar condiciones peligrosas o inseguras, así como 
            la prioridad con la que se atienden.
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta50">El seguimiento a las recomendaciones formuladas en los recorridos de verificación anteriores.
        ...
        <div class="conteiner">
          <label for="pregunta51">El lugar y fecha de conclusión del acta.
        ...
        <div class="conteiner">
          <label for="pregunta52">El nombre y firma de los integrantes de la comisión que participaron en el recorrido de verificación.
        ...
        <div>
            ...
            <label class="conteiner">5.7 Facilitar a los trabajadores el desempeño de sus funciones como integrantes de la comisión.
            </label>
          </div>
             <hr class="styled-separator">
             <div>
        ...
        <div class="conteiner">
          <label for="pregunta53">Al entrevistar al menos a un integrante de la comisión, éste refiere que se les brindan facilidades para el desempeño de sus funciones como integrante de la misma.
        ...
        <div>
            ...
            <label class="conteiner">5.8 Proporcionar a la comisión el diagnóstico sobre seguridad y salud en el trabajo, a que se refiere la NOM-030-STPS-2009, o las que la sustituyan.
        ...
        <div class="conteiner">
          <label for="pregunta54">Presenta evidencia documental de que proporciona a la comisión el diagnóstico sobre seguridad y salud en el trabajo, a que se refiere la NOM-030-STPS-2009, o las que la sustituyan.
        ...
        <div>
            ...
            <label class="conteiner">5.9 Apoyar la investigación de los accidentes y enfermedades de trabajo que lleve a cabo la comisión, proporcionando para tal efecto información sobre:
        ...
        <div class="conteiner">
          <label for="pregunta55">Presenta evidencia documental de que apoya la investigación de los accidentes y enfermedades de trabajo que lleve a cabo la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta56">Los incidentes, accidentes y enfermedades de trabajo que ocurran en el centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta57">Los procesos de trabajo y las hojas de datos de seguridad de las sustancias químicas utilizadas.
        ...
        <div class="conteiner">
          <label for="pregunta58">El seguimiento a las causas de los riesgos de trabajo que tengan lugar en el centro laboral.
        ...
        <div>
            ...
            <label class="conteiner">5.10 Brindar facilidades a los integrantes de la comisión para que utilicen los apoyos informáticos desarrollados por la Secretaría.
        ...
        <div class="conteiner">
          <label for="pregunta59">Presenta evidencia documental de que a los integrantes de la comisión se les brindan facilidades para utilizar los apoyos informáticos desarrollados por la Secretaría, para la 
            identificación y determinación de las disposiciones normativas en materia de seguridad y salud aplicables al centro de trabajo, así como para la determinación de las 
            medidas por adoptar para prevenir riesgos de trabajo en el centro laboral y el seguimiento a su instauración en el centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta60">Presenta evidencia documental de que a los integrantes de la comisión se les brindan facilidades para utilizar los apoyos informáticos desarrollados por la Secretaría, para la 
            identificación y determinación de las disposiciones normativas en materia de seguridad y salud aplicables al centro de trabajo, así como para la determinación de las 
            medidas por adoptar para prevenir riesgos de trabajo en el centro laboral y el seguimiento a su instauración en el centro de trabajo.
        ...
        <div>
            ...
            <label class="conteiner">9.8 Para la determinación de las medidas por adoptar para prevenir riesgos de trabajo en el centro de trabajo y el seguimiento a su instauración, la comisión podrá utilizar el módulo para la Elaboración de Programas de Seguridad y Salud en el Trabajo, contenido en la página electrónica de la Secretaría http://autogestion.stps.gob.mx:8162/.
        ...
        <div class="conteiner">
          <label for="pregunta61">Presenta evidencia documental de que a los integrantes de la comisión se les brindan facilidades para utilizar los apoyos informáticos desarrollados por la Secretaría, para la 
            identificación y determinación de las disposiciones normativas en materia de seguridad y salud aplicables al centro de trabajo, así como para la determinación de las 
            medidas por adoptar para prevenir riesgos de trabajo en el centro laboral y el seguimiento a su instauración en el centro de trabajo.
        ...
        <div>
            ...
            <label class="conteiner">5.11 Atender y dar seguimiento a las medidas propuestas por la comisión para prevenir los riesgos de trabajo, de acuerdo con los resultados de las actas de los recorridos de verificación y con base en lo dispuesto por el Reglamento y las normas que resulten aplicables.
        ...
        <div class="conteiner">
          <label for="pregunta62">Atiende las medidas propuestas por la comisión para prevenir los riesgos de trabajo, de acuerdo con los resultados de las actas de los recorridos de verificación y con base en lo 
        ...
        <div>
            ...
            <label class="conteiner">9.11 El seguimiento de las medidas propuestas por la comisión relacionadas con la prevención de riesgos de trabajo, deberá efectuarse al menos en forma trimestral.
        ...
        <div class="conteiner">
          <label for="pregunta63">Da seguimiento a las medidas propuestas por la comisión relacionadas con la prevención de riesgos de trabajo, al menos en forma trimestral.
        ...
        <div>
            ...
            <label class="conteiner">5.12 Difundir entre los trabajadores del centro de trabajo, por cualquier medio:
        ...
        <div class="conteiner">
          <label for="pregunta64">La relación actualizada de los integrantes de la comisión, precisando el puesto, turno y área de trabajo de cada uno de ellos.
        ...
        <div class="conteiner">
          <label for="pregunta65">Los resultados de las investigaciones, con las causas y consecuencias, sobre los accidentes y enfermedades de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta66">Las medidas propuestas por la comisión, relacionadas con la prevención de riesgos de trabajo, a fin de evitar su recurrencia.
        ...
        <div>
            ...
            <label class="conteiner">5.13 Proporcionar a los integrantes de la comisión, al menos una vez por año, capacitación para la adecuada realización de sus funciones, con base en el programa que para tal efecto se elabore.
        ...
        <div class="conteiner">
          <label for="pregunta67">Proporciona capacitación a los integrantes de la comisión, al menos una vez al año.
        ...
        <div>
            ...
            <label class="conteiner">10.1 Los centros de trabajo deberán disponer de un programa anual de capacitación para los integrantes de la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta68">Dispone de un programa anual de capacitación para los integrantes de la comisión.
        ...
        <div>
            ...
            <label class="conteiner">10.2 El programa anual de capacitación de los integrantes de la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta69">Los integrantes de la comisión involucrados en la capacitación.
        ...
        <div>
            ...
            <label class="conteiner">10.3 Cuando se incorpore a un nuevo integrante o integrantes a la comisión, se deberá proporcionar de inmediato un curso de inducción.
            </label>
          </div>
             <hr class="styled-separator">
             <div>
        ...
        <div class="conteiner">
          <label for="pregunta70">Los temas de la capacitación de acuerdo con el programa anual de capacitación de los integrantes de la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta71">Los tiempos de duración de los cursos y su período de ejecución.
        ...
        <div class="conteiner">
          <label for="pregunta72">El nombre del responsable del programa.
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta73">Las obligaciones del patrón y de los trabajadores respecto del funcionamiento de la comisión.
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta74">La forma cómo debe constituirse e integrarse la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta75">Las responsabilidades del coordinador, del secretario y de los vocales de la comisión.
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta76">Las funciones que tiene encomendadas la comisión.
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta77">Los temas en materia de seguridad y salud en el trabajo aplicables al centro de trabajo.
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta78">Las medidas de seguridad y salud que se deben observar en el centro de trabajo, con base en lo dispuesto por el Reglamento y las normas que resulten aplicables.
        ...
        <div class="conteiner">
          <label for="pregunta79">La metodología para la identificación de condiciones peligrosas o inseguras y actos inseguros en el centro de trabajo.
        ...
        <div class="conteiner">
          <label for="pregunta80">El procedimiento para la investigación sobre las causas de los accidentes y enfermedades de trabajo que ocurran.
        ...
        <div class="conteiner">
          <label for="pregunta81">Al incorporar a nuevos integrantes a la comisión, se les proporcionan de inmediato cursos de inducción.
        ...
        <div class="conteiner">
          <label for="pregunta82">Las obligaciones del patrón y de los trabajadores respecto del funcionamiento de la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta83">La forma cómo debe constituirse e integrarse la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta84">Las responsabilidades del coordinador, del secretario y de los vocales de la comisión.
        ...
        <div class="conteiner">
          <label for="pregunta85">Las funciones que tiene encomendadas la comisión.
            </label>
          <div class="radio-buttons">
        ...
        <input type="submit" name="guardar_n0192011" value="Enviar">
      </form>
