...
<?php 
    $query = "SELECT * FROM norma302009 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    ...
    if ($numRespuestas > 0) {
        $query2 = "SELECT " . implode(", ", $respuestasArray) . " FROM norma302009 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
...
<head>
    ...
    <title>Normas/NOM-030-STPS-2009.HTML</title>
</head>
<body>
    <div class="barrasuperior">
        <h1>Norma NOM-030-STPS-2009</h1>
    ...
    <form action="guardar_n302009.php" method="POST">
        <div>
            <h2>
                Disposición
            </h2>
            <label class="conteiner">4.1 Designar a un responsable de seguridad y salud en el trabajo interno o externo, para llevar a cabo las funciones y actividades preventivas de seguridad y salud en el centro de trabajo.
                </label>
        </div>
        <hr class="styled-separator">

          <div class="conteiner">
              <label for="pregunta1">Presenta evidencia documental de que cuenta con un responsable de seguridad y salud en el trabajo que lleve a cabo las funciones y actividades establecidas 
                en funciones y actividades del responsable de seguridad y salud en el trabajo.
            </label>
        ...
        <div>
          ...
          <label class="conteiner">4.1.1 Los centros de trabajo que cuenten con menos de cien trabajadores deberán elaborar una relación de acciones preventivas y correctivas de seguridad y salud en el trabajo, de acuerdo con las actividades que desarrollen. La relación de acciones preventivas y correctivas deberá actualizarse al menos una vez al año.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
        ...
        <div class="conteiner">
          <label for="pregunta2">Mediante entrevista, se constate que él asume las funciones y actividades preventivas de seguridad y salud a que se refiere al funciones y 
actividades del responsable de seguridad y salud en el trabajo.
            </label>
          <div class="radio-buttons">
      ...
      <div>
          ...
          <label class="conteiner">4.2 Proporcionar al responsable de seguridad y salud en el trabajo.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
        ...
        <div class="conteiner">
          <label for="pregunta3">Presenta evidencia documental de que al responsable de seguridad y salud en el trabajo.
          </label>
          <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta4">Las facilidades para ingresar a las diferentes áreas del centro de trabajo para identificar los factores de peligro y la exposición de los trabajadores.
        </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta5">La información relacionada con la seguridad y salud en el trabajo de los procesos, puestos de trabajo y actividades desarrolladas por los trabajadores.
          </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta6">Los medios y facilidades necesarios para establecer las medidas de seguridad y salud en el trabajo para la prevención de los accidentes y enfermedades de trabajo.
          </label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">4.3 Contar con un diagnóstico integral o por área de trabajo de las condiciones de seguridad y salud del centro laboral, de acuerdo con el diagnóstico de seguridad y salud en el trabajo El diagnóstico integral comprenderá a las diversas áreas, secciones o procesos que conforman al centro de trabajo, en tanto que el relativo al área de trabajo, se referirá de manera exclusiva a cada una de ellas.
        </label>
      </div>
      <hr class="styled-separator">
        <!-- Disposicion -->
      ...
      <div class="conteiner">
        <label for="pregunta7">Presenta un diagnóstico integral o por áreas de trabajo de las condiciones de seguridad y salud del centro laboral, elaborado de acuerdo con lo que establece 
el diagnóstico integral o por área de trabajo sobre las condiciones de seguridad y salud en el centro laboral.
      ...
      <div>
          ...
          <label class="conteiner">6.1 El diagnóstico integral o por área de trabajo sobre las condiciones de seguridad y salud en el centro laboral.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
      ...
      <div class="conteiner">
        <label for="pregunta8">Las condiciones físicas peligrosas o inseguras que puedan representar un riesgo en las instalaciones, procesos, maquinaria, equipo, herramientas, medios de transporte, materiales y energía.
          </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta9">Los agentes físicos, químicos o biológicos capaces de modificar las condiciones del medio ambiente del centro de trabajo que, por sus propiedades, concentración, nivel y tiempo de exposición 
        o acción, pueden alterar la salud de los trabajadores, así como las fuentes que los generan.
        </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta10">Los peligros circundantes al centro de trabajo que lo puedan afectar, cuando sea posible.
      ...
      <div class="conteiner">
        <label for="pregunta11">Los requerimientos normativos en materia de seguridad y salud en el trabajo que le resulten aplicables.
        </label>
        <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">4.4 Contar con un programa de seguridad y salud en el trabajo.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
      ...
      <div class="conteiner">
        <label for="pregunta12">Presenta un programa o una relación de acciones preventivas y correctivas de seguridad y salud, actualizado al menos una vez al año.
      ...
      <div>
          ...
          <label class="conteiner">4.4.1 Los centros de trabajo que cuenten con menos de cien trabajadores deberán elaborar una relación de acciones preventivas y correctivas de seguridad y salud en el trabajo, de acuerdo con las actividades que desarrollen. La relación de acciones preventivas y correctivas deberá actualizarse al menos una vez al año.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
      ...
      <div class="conteiner">
        <label for="pregunta13">Presenta un programa o una relación de acciones preventivas y correctivas de seguridad y salud, actualizado al menos una vez al año.
      ...
      <div class="conteiner">
        <label for="pregunta14">Presenta un programa de seguridad y salud en el trabajo, elaborado con base en el diagnóstico.
      ...
      <div>
          ...
          <label class="conteiner">7.1 El programa de seguridad y salud en el trabajo.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
      ...
      <div class="conteiner">
        <label for="pregunta15">La acción preventiva o correctiva por instrumentar por cada aspecto identificado.
      ...
      <div class="conteiner">
        <label for="pregunta16">Las acciones y programas de promoción para la salud de los trabajadores y para la prevención integral de las adicciones que recomienden o dicten las autoridades competentes.
          </label>
        <div class="radio-buttons">
        ...
        <!-- Pregunta 17 -->
        <div class="conteiner">
          <label for="pregunta17">Las acciones para la atención de emergencias y contingencias sanitarias que recomienden o dicten las autoridades competentes.
            </label>
          <div class="radio-buttons">
        ...
        <!-- Pregunta 18 -->
        <div class="conteiner">
          <label for="pregunta18">Las fechas de inicio y término programadas para instrumentar las acciones preventivas o correctivas y para la atención de emergencias.
        ...
        <!-- Pregunta 19 -->
        <div class="conteiner">
          <label for="pregunta19">El responsable de la ejecución de cada acción preventiva o correctiva y para la atención de emergencias.
        ...
        <!-- Pregunta 20 -->
        <div class="conteiner">
          <label for="pregunta20">Presenta una relación de acciones preventivas y correctivas de seguridad y salud en el trabajo, elaborada con base en el diagnóstico.
        ...
        <div>
          ...
          <label class="conteiner">7.2 La relación de acciones preventivas y correctivas de seguridad y salud en los centros de trabajo que cuenten con menos de cien trabajadores.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
        ...
        <!-- Pregunta 21 -->
        <div class="conteiner">
          <label for="pregunta21">La acción preventiva o correctiva por instrumentar por cada aspecto identificado.
        ...
        <div class="conteiner">
          <label for="pregunta22">Las acciones y programas de promoción para la salud de los trabajadores y para la prevención integral de las adicciones que recomienden o dicten las autoridades competentes.
        ...
        <div class="conteiner">
          <label for="pregunta23">Las acciones para la atención de emergencias y contingencias sanitarias que recomienden o dicten las autoridades competentes.
        ...
        <div class="conteiner">
          <label for="pregunta24">Las fechas de inicio y término programadas para instrumentar las acciones preventivas o correctivas y para la atención de emergencias.
        ...
        <div>
          ...
          <label class="conteiner">4.5 Comunicar a la comisión de seguridad e higiene y/o a los trabajadores, según aplique, el diagnóstico integral o por área de trabajo de las condiciones de seguridad y salud y el contenido del programa de seguridad y salud en el trabajo o de la relación de acciones preventivas y correctivas de seguridad y salud en el trabajo.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
        ...
        <div class="conteiner">
          <label for="pregunta25">Demuestra que comunica a la comisión de seguridad e higiene y/o a los trabajadores, según aplique, el diagnóstico integral o por áreas de trabajo de las condiciones de seguridad y salud 
y el contenido del programa de seguridad y salud en el trabajo o de la relación de acciones preventivas y correctivas de seguridad y salud en el trabajo.
            </label>
          <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">4.6 Contar con los reportes de seguimiento de los avances en la instauración del programa de seguridad y salud en el trabajo o de la relación de acciones preventivas y correctivas de seguridad y salud en el trabajo.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
        ...
        <div class="conteiner">
          <label for="pregunta26">Presenta los reportes de seguimiento de los avances en la instauración del programa de seguridad y salud en el trabajo o de la relación de acciones preventivas y correctivas de seguridad y salud en el trabajo, 
            según aplique.
            </label>
          <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">4.7 Capacitar al personal de la empresa que forme parte de los servicios preventivos de seguridad y salud en el trabajo, en las funciones y actividades.
          </label>
        </div>
        <hr class="styled-separator">
          <!-- Disposicion -->
        ...
        <div class="conteiner">
          <label for="pregunta27">Demuestra que al personal de la empresa que forme parte de los servicios preventivos de seguridad y salud en el trabajo, se le capacita en las funciones y actividades.
        ...
        <input type="submit" name="guardar_n302009" value="Enviar">
      </form>
