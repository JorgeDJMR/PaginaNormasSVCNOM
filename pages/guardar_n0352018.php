...
if(isset($_POST['guardar_n0352018'])){
...
$queryCheck = "SELECT * FROM norma352018 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    ...
    header("Location: ../pages\NOM-035-STPS-2018.php");
}
