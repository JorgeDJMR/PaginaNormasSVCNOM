...
if(isset($_POST['guardar_n362018'])){
...
$queryCheck = "SELECT * FROM norma362018 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    ...
    header("Location: ../pages\NOM-036-STPS-2018.php");
}
