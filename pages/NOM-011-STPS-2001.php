...
<?php 
    $query = "SELECT * FROM norma112001 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    ...
    if ($numRespuestas > 0) {
        $query2 = "SELECT " . implode(", ", $respuestasArray) . " FROM norma112001 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
...
<head>
    ...
    <title>Normas/NOM-011-STPS-2001.HTML</title>
</head>
<body>
    <div class="barrasuperior">
        <h1>Norma NOM-011-STPS-2001</h1>
    ...
    <form action="guardar_n112001.php" method="post">
        <div>
            <h2>
                Disposición
            </h2>
            <label class="conteiner">5.2 Contar con el reconocimiento y evaluación de todas las áreas del centro de trabajo donde haya trabajadores y cuyo NSA sea igual o superior a 80 dB(A), incluyendo sus características y componentes de frecuencia</label>
        </div>
        <hr class="styled-separator">

          <div class="conteiner">
              <label for="pregunta1">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?</label>
        ...
        <div class="conteiner">
          <label for="pregunta2">¿Dictamen de las unidades de verificacion?</label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta3">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
          </label>
          <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta4">¿Datos de la unidad de verificación: nombre, denominación o razón social de la unidad de verificación, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, clave 
      ...
      <div class="conteiner">
        <label for="pregunta5">¿ La vigencia de los dictámenes emitidos por las unidades de verificación será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las condiciones de operación, 
      ...
      <div>
        ...
        <label class="conteiner">5.3 Verificar que ningún trabajador se exponga a niveles de ruido mayores a los límites máximos permisibles de exposición a ruido En ningún caso, debe haber exposición sin equipo de protección personal auditiva a más de 105 dB(A)
        </label>
      </div>
      <hr class="styled-separator">
           <div>
      ...
      <div class="conteiner">
        <label for="pregunta6">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?
          </label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.4 Proporcionar el equipo de protección personal auditiva, de acuerdo a lo establecido en la NOM-017-STPS-1993, a todos los trabajadores expuestos a NSA igual o superior a 85 dB(A).
        </label>
      </div>
      <hr class="styled-separator">
           <div>
      ...
      <div class="conteiner">
        <label for="pregunta11">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?
        </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta12">¿Dictamen de las unidades de verificacion?
          </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta13">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
        </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta14">¿Datos de la unidad de verificación: nombre, denominación o razón social de la unidad de verificación, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, clave 
          y nombre de la norma verificada, resultado de la verificación, nombre y firma del representante autorizado, lugar y fecha de la expedición del dictamen, vigencia del dictamen?
          </label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta15">¿ La vigencia de los dictámenes emitidos por las unidades de verificación será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las condiciones de operación, 
          de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
          </label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.5 El programa de conservación de la audición aplica en las áreas del centro de trabajo donde se encuentren trabajadores expuestos a niveles de 85 dB(A) y mayores.
        </label>
      </div>
      <hr class="styled-separator">
           <div>
      ...
      <div class="conteiner">
        <label for="pregunta16">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?
          </label>
        <div class="radio-buttons">
        ...
        <!-- Pregunta 18 -->
        <div class="conteiner">
          <label for="pregunta18">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
          </label>
          <div class="radio-buttons">
        ...
        <!-- Pregunta 19 -->
        <div class="conteiner">
          <label for="pregunta19">¿Datos de la unidad de verificación: nombre, denominación o razón social de la unidad de verificación, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, clave 
            y nombre de la norma verificada, resultado de la verificación, nombre y firma del representante autorizado, lugar y fecha de la expedición del dictamen, vigencia del dictamen?
            </label>
          <div class="radio-buttons">
        ...
        <!-- Pregunta 20 -->
        <div class="conteiner">
          <label for="pregunta20">¿ La vigencia de los dictámenes emitidos por las unidades de verificación será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las condiciones de operación, 
            de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
          </label>
          <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.6 Implantar, conservar y mantener actualizado el programa de conservación de la audición, necesario para el control y prevención de las alteraciones de la salud de los trabajadores
        </label>
      </div>
      <hr class="styled-separator">
           <div>
        ...
        <!-- Pregunta 21 -->
        <div class="conteiner">
          <label for="pregunta21">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta22">¿Dictamen de las unidades de verificacion?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta23">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta24">¿Datos de la unidad de verificación: nombre, denominación o razón social de la unidad de verificación, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, clave 
            y nombre de la norma verificada, resultado de la verificación, nombre y firma del representante autorizado, lugar y fecha de la expedición del dictamen, vigencia del dictamen?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta25">¿ La vigencia de los dictámenes emitidos por las unidades de verificación será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las condiciones de operación, 
            de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
            </label>
          <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">5.7  Vigilar la salud de los trabajadores expuestos a ruido e informar a cada trabajador sus resultados
          </label>
        </div>
        <hr class="styled-separator">
           <div>
        ...
        <div class="conteiner">
          <label for="pregunta26">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta27">¿Dictamen de las unidades de verificacion?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta28">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta29">¿Datos de la unidad de verificación: nombre, denominación o razón social de la unidad de verificación, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, clave 
            y nombre de la norma verificada, resultado de la verificación, nombre y firma del representante autorizado, lugar y fecha de la expedición del dictamen, vigencia del dictamen?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta30">¿ La vigencia de los dictámenes emitidos por las unidades de verificación será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las condiciones de operación, 
            de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
            </label>
          <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">5.8  Informar a los trabajadores y a la comisión de seguridad e higiene del centro de trabajo, de las posibles alteraciones a la salud por la exposición a ruido, y orientarlos sobre la forma de evitarlas o atenuarlas.
          </label>
        </div>
        <hr class="styled-separator">

        <div class="conteiner">
          <label for="pregunta31">¿Las unidades de verificación deben entregar al patrón sus dictámenes e informes de resultados consignando la siguiente información?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta32">¿Dictamen de las unidades de verificacion?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta33">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta34">¿Datos de la unidad de verificación: nombre, denominación o razón social de la unidad de verificación, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, clave 
            y nombre de la norma verificada, resultado de la verificación, nombre y firma del representante autorizado, lugar y fecha de la expedición del dictamen, vigencia del dictamen?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta35">¿La vigencia de los dictámenes emitidos por las unidades de verificación será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las condiciones de operación, 
            de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
            </label>
          <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">8.2 Evaluación del NSA promedio o del NSCEA,t y la determinación del NER. Los requisitos de la evaluación del NSA promedio o del NSCEA,T
          </label>
        </div>
        <hr class="styled-separator">
           <div>
        ...
        <div class="conteiner">
          <label for="pregunta36">¿El patrón tendrá la opción de contratar una un laboratorio de pruebas acreditado y aprobado, según lo establecido en la Ley Federal sobre Metrología y Normalización, para verificar
            o evaluar esta Norma?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta37">¿Informe de resultados de los laboratorios de pruebas?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta38">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta39">¿Datos del laboratorio de prueba: nombre, denominación o razón social, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, nombre y firma del 
            signatario autorizado, lugar y fecha de la expedición del informe, conclusiones de la evaluación, contenido de los estudios?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta40">¿La vigencia de los dictámenes de los informes de resultados de los laboratorios de pruebas será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las 
            condiciones de operación, de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
          </label>
          <div class="radio-buttons">
        ...
        <div>
          ...
          <label class="conteiner">8.3  Evaluación del NPA en bandas de octava.
          </label>
        </div>
        <hr class="styled-separator">
           <div>
        ...
        <div class="conteiner">
          <label for="pregunta41">¿El patrón tendrá la opción de contratar una un laboratorio de pruebas acreditado y aprobado, según lo establecido en la Ley Federal sobre Metrología y Normalización, para verificar
            o evaluar esta Norma?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta42">¿Informe de resultados de los laboratorios de pruebas?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta43">¿Datos del centro de trabajo evaluado: nombre, denominación o razón social, domicilio completo?
            </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta44">¿del laboratorio de prueba: nombre, denominación o razón social, número de aprobación otorgado por la Secretaría del Trabajo y Previsión Social, nombre y firma del 
            signatario autorizado, lugar y fecha de la expedición del informe, conclusiones de la evaluación, contenido de los estudios?
          </label>
          <div class="radio-buttons">
        ...
        <div class="conteiner">
          <label for="pregunta45">¿La vigencia de los dictámenes de los informes de resultados de los laboratorios de pruebas será de dos años, a menos que se modifique la maquinaría, el equipo, su distribución o las 
            condiciones de operación, de tal manera que puedan ocasionar variaciones en los resultados de la evaluación del ruido?
          </label>
          <div class="radio-buttons">
        ...
        <input type="submit" value="Enviar" name="guardar_n112001">
      </form>
