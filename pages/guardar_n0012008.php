...
if(isset($_POST['guardar_n0012008'])){
...
$respuesta108 = isset($_POST['pregunta108']) ? $_POST['pregunta108'] : '';
    ...
    header("Location: ../pages\NOM-001-STPS-2008.php");
