...
if(isset($_POST['guardar_n172008'])){
    ...
    if (mysqli_num_rows($resultCheck) > 0) {
        ...
        $query = "INSERT INTO norma172008 (registroID, usuarioID, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43, r44, r45) 
    ...
    header("Location: ../pages\NOM-017-STPS-2008.php");
}
