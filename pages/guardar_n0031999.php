...
if(isset($_POST['guardar_n0031999'])){
...
$respuesta108 = isset($_POST['pregunta108']) ? $_POST['pregunta108'] : '';
    ...
    header("Location: ../pages\NOM-003-STPS-1999.php");
}
