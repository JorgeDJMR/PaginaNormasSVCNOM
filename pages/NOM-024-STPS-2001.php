...
<?php 
    $query = "SELECT * FROM norma242001 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    ...
    if ($numRespuestas > 0) {
        $query2 = "SELECT " . implode(", ", $respuestasArray) . " FROM norma242001 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
...
<head>
    ...
    <title>Normas/NOM-024-STPS-2001.HTML</title>
</head>
<body>
    <div>
        <h1>Norma NOM-024-STPS-2001</h1>
    ...
    <form action="guardar_n242001.php" method="POST">
        <div>
            <h2>
                Disposición
            </h2>
            <label class="conteiner">5.2  Informar a todos los trabajadores sobre las posibles alteraciones a la salud por la exposición a vibraciones.
        </div>
        ...
        <div class="conteiner">
            <label for="pregunta1">El patrón puede contratar, para tener resultados con reconocimiento oficial, una unidad de verificación, acreditada y aprobada, según lo establecido en la Ley Federal sobre Metrología y Normalización.</label>
      ...
      <div class="conteiner">
        <label for="pregunta2">Dictamen de unidades de verificación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta3">Datos de la unidad de verificación: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, número 
            consecutivo de identificación del dictamen, fecha de la verificación, clave y nombre de la norma verificada,  resultados de la verificación,  lugar y fecha de la firma del dictamen,  nombre y firma 
            del representante legal, vigencia del dictamen.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta4">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.3 Vigilar que no se rebasen los límites máximos permisibles de exposición.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta5">El patrón puede contratar, para tener resultados con reconocimiento oficial, una unidad de verificación, acreditada y aprobada, según lo establecido en la Ley Federal sobre Metrología y
            Normalización.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta6">Dictamen de unidades de verificación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta7">Datos de la unidad de verificación: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, número 
            consecutivo de identificación del dictamen, fecha de la verificación, clave y nombre de la norma verificada,  resultados de la verificación,  lugar y fecha de la firma del dictamen,  nombre y firma 
            del representante legal, vigencia del dictamen.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta8">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.4 Elaborar y mantener vigente el Programa para la Prevención de Alteraciones a la Salud del POE.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta9">El patrón puede contratar, para tener resultados con reconocimiento oficial, una unidad de verificación, acreditada y aprobada, según lo establecido en la Ley Federal sobre Metrología y Normalización</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta10">Dictamen de unidades de verificación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta11">Datos de la unidad de verificación: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, número 
            consecutivo de identificación del dictamen, fecha de la verificación, clave y nombre de la norma verificada,  resultados de la verificación,  lugar y fecha de la firma del dictamen,  nombre y firma 
            del representante legal, vigencia del dictamen.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta12">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.5 Capacitar y adiestrar al POE anualmente en el Programa para la Prevención de Alteraciones a la Salud del POE.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta13">El patrón puede contratar, para tener resultados con reconocimiento oficial, una unidad de verificación, acreditada y aprobada, según lo establecido en la Ley Federal sobre Metrología y Normalización.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta14">Dictamen de unidades de verificación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta15">Datos de la unidad de verificación: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, número 
            consecutivo de identificación del dictamen, fecha de la verificación, clave y nombre de la norma verificada,  resultados de la verificación,  lugar y fecha de la firma del dictamen,  nombre y firma 
            del representante legal, vigencia del dictamen.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta16">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">5.6 Realizar la vigilancia a la salud del POE.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta17">El patrón puede contratar, para tener resultados con reconocimiento oficial, una unidad de verificación, acreditada y aprobada, según lo establecido en la Ley Federal sobre Metrología y Normalización.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta18">Dictamen de unidades de verificación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta19">Datos de la unidad de verificación: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, número 
            consecutivo de identificación del dictamen, fecha de la verificación, clave y nombre de la norma verificada,  resultados de la verificación,  lugar y fecha de la firma del dictamen,  nombre y firma 
            del representante legal, vigencia del dictamen.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta20">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
          <input type="radio" id="p20-0" name="pregunta22" value="0">
          <label for="p20-0">0</label>
          <input type="radio" id="p20-1" name="pregunta22" value="1">
          <label for="p20-1">1</label>
          <input type="radio" id="p20-2" name="pregunta22" value="2">
          <label for="p20-2">2</label>
          <input type="radio" id="p20-3" name="pregunta22" value="3">
          <label for="p20-3">3</label>
          <input type="radio" id="p20-4" name="pregunta22" value="4">
      ...
      <div>
        ...
        <label class="conteiner">5.7 No exponer a vibraciones a mujeres en estado de gestación
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta21">El patrón puede contratar, para tener resultados con reconocimiento oficial, una unidad de verificación, acreditada y aprobada, según lo establecido en la Ley Federal sobre Metrología y Normalización.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta22">Dictamen de unidades de verificación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta23">Datos de la unidad de verificación: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, número 
            consecutivo de identificación del dictamen, fecha de la verificación, clave y nombre de la norma verificada,  resultados de la verificación,  lugar y fecha de la firma del dictamen,  nombre y firma 
            del representante legal, vigencia del dictamen.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta24">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">8.2 Reconocimiento. Consiste en recabar toda aquella informacion tecnica y administrativa que permita seleccionar las areas y puestos por evaluar, los procesos de trabajo en los cuales se encuentra el POE y el metodo apropiado para medir las vibraciones.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta25">El patrón puede contratar, para tener resultados con reconocimiento oficial, un laboratorio de pruebas, acreditado y aprobado, según lo establecido en la Ley Federal sobre Metrología y Normalización, para el reconocimiento y evaluación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta26">Informe del laboratorio de pruebas.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta27">Datos del laboratorio de pruebas: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, contenido 
          del estudio, resultados de la evaluación,  nombre y firma del representante legal, lugar y fecha de la firma del informe, vigencia del informe.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta28">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">8.3 Evaluación.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta29">El patrón puede contratar, para tener resultados con reconocimiento oficial, un laboratorio de pruebas, acreditado y aprobado, según lo establecido en la Ley Federal sobre Metrología y Normalización, para el reconocimiento y evaluación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta30">Informe del laboratorio de pruebas.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta31">Datos del laboratorio de pruebas: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, contenido 
          del estudio, resultados de la evaluación,  nombre y firma del representante legal, lugar y fecha de la firma del informe, vigencia del informe.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta32">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
      ...
      <div>
        ...
        <label class="conteiner">8.7 Documentación.
        </label>
    </div>
    <hr class="styled-separator">
    <div>
      ...
      <div class="conteiner">
        <label for="pregunta33">El patrón puede contratar, para tener resultados con reconocimiento oficial, un laboratorio de pruebas, acreditado y aprobado, según lo establecido en la Ley Federal sobre Metrología y Normalización, para el reconocimiento y evaluación.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta34">Informe del laboratorio de pruebas.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta35">Datos del laboratorio de pruebas: nombre, denominación o razón social,  domicilio completo, copia de la aprobación vigente otorgada por la Secretaría del Trabajo y Previsión Social, contenido 
          del estudio, resultados de la evaluación,  nombre y firma del representante legal, lugar y fecha de la firma del informe, vigencia del informe.</label>
        <div class="radio-buttons">
      ...
      <div class="conteiner">
        <label for="pregunta36">La vigencia del dictamen y del informe de resultados es de dos años, sujeto a que no se modifiquen las tareas, el área de trabajo, las herramientas o equipos del proceso de tal manera 
            que se puedan incrementar las características de las vibraciones o los ciclos de exposición.</label>
        <div class="radio-buttons">
        ...
        <input type="submit" value="Enviar" name="guardar_n242001">
      </form>
