...
if(isset($_POST['guardar_n252008'])){
    ...
    $queryCheck = "SELECT * FROM norma252008 WHERE usuarioID = '{$_SESSION['usuarioID']}'";
    $resultCheck = mysqli_query($conn, $queryCheck);

    if (mysqli_num_rows($resultCheck) > 0) {
        $queryUpdate = "UPDATE norma252008 SET r1='$respuesta1,$comentario1', r2='$respuesta2,$comentario2', r3='$respuesta3,$comentario3', r4='$respuesta4,$comentario4', r5='$respuesta5,$comentario5', r6='$respuesta6,$comentario6', r7='$respuesta7,$comentario7', r8='$respuesta8,$comentario8', r9='$respuesta9,$comentario9', r10='$respuesta10,$comentario10', r11='$respuesta11,$comentario11', r12='$respuesta12,$comentario12', r13='$respuesta13,$comentario13', r14='$respuesta14,$comentario14', r15='$respuesta15,$comentario15', r16='$respuesta16,$comentario16', r17='$respuesta17,$comentario17', r18='$respuesta18,$comentario18', r19='$respuesta19,$comentario19', r20='$respuesta20,$comentario20', r21='$respuesta21,$comentario21', r22='$respuesta22,$comentario22', r23='$respuesta23,$comentario23', r24='$respuesta24,$comentario24', r25='$respuesta25,$comentario25' WHERE usuarioID = '{$_SESSION['usuarioID']}'";
        ...
        $query = "INSERT INTO norma252008 (registroID, usuarioID, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25) 
    ...
    header("Location: ../pages\NOM-025-STPS-2008.php");
}
